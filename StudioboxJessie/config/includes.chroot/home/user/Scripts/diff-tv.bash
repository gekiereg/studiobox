...
echo "Quelle taille de vidéo désirez-vous?"
select yn in "720x576" "540x432" "480x384" "360x288" "240x192"; do
    case $yn in
        720x576 )l='720';h='576';break;;
	540x432 )l='540';h='432';break;;
	480x384 )l='480';h='384';break;;
	360x288 )l='360';h='288';break;;
	240x192 )l='240';h='192';break;;
    esac
done
...
##
##
dvgrab --format raw - | ffmpeg2theora -f dv -x $l -y $h -a $quality -v $quality -o /dev/stdout -  | oggfwd $hote $port $pass /$point" > diffusion.bash
chmod +x diffusion.bash
exec ./diffusion.bash
