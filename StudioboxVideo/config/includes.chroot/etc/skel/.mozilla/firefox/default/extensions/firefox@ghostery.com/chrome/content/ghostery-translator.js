...
ghostery.translator = {
	...
	'en': {
		...
		'settings.desc': "When you enable GhostRank, Ghostery collects anonymous data about the trackers you've encountered and the sites on which they were placed. This data is about tracking elements and the webpages on which they are found, <strong>not you or your browsing habits</strong>.<br><br>Online marketing companies need better visibility into real-world applications of their technologies and those owned by their competitors. GhostRank data is sold as reports to businesses to help them market to consumers more transparently, better manage their web properties, and comply with privacy standards.<br><br><strong>GhostRank data shared with businesses never includes data about Ghostery users.</strong> To learn more about the data that GhostRank collects, <a href='https://www.ghostery.com/faq#q16' target='_new'>click here</a>.",
		'settings.desc2': "We also <a href='http://purplebox.ghostery.com/?p=1016023378' target='_new'>publish our own research</a> and provide data to privacy researchers[<a href='http://purplebox.ghostery.com/?p=10160233931' target='_new'>1</a>][<a href='https://wiki.digitalmethods.net/Dmi/DmiWinterSchool2012TrackingTheTrackers' target='_new'>2</a>], analysts and journalists. Additionally, organizations like the <a href='http://purplebox.ghostery.com/?p=1016021311' target='_new'>Better Business Bureau</a> use GhostRank data in the enforcement of privacy standards like the <a href='http://www.aboutads.info/' target='_new'>DAA AdChoices</a> program.",
		'settings.desc3':"We hope you'll opt-in to GhostRank, but if you do not enable data sharing, we won't collect anything. To read more about how the Ghostery service supports the Evidon business, read our post <a href='http://purplebox.ghostery.com/?p=1016023438' target='_new'>The Most Frequently Asked Question</a>.",
